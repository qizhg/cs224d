...
def softmax(x):
  ...
  ### YOUR CODE HERE
  x_tilde = x - tf.reduce_max(x, reduction_indices=1, keep_dims=True)
  x_tilde_exp = tf.exp(x_tilde)
  out = x_tilde_exp / tf.reduce_sum(x_tilde_exp, reduction_indices=1, keep_dims=True)
  ### END YOUR CODE
